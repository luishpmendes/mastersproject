...
/* The GreedyConstructiveHeuristic represents a constructive heuristic for the CEDP. */
class GreedyConstructiveHeuristic : public Heuristic {
    ...
    public:
         ...
         */
        GreedyConstructiveHeuristic(const Instance & instance, unsigned int seed, double alpha);
